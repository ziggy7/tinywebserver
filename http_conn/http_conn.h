...
enum METHOD{ GET=0, POST, HEAD, PUT };       //HTTP请求方法，但只支持GET
...
public:
    ...
    void initmysql_result(connection_pool *connPool);//SYN
    //void initresultFile(connection_pool *connPool);//CGI
...
private:
    ...
    /*客户请求的目标文件的完整路径，内容等于doc_root(根目录) + m_URL*/
